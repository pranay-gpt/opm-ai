...
Cohesion: 0.10
Nodes (53): _apply_log(), _base_layout(), _field_figure_per_property(), _get_unit_labels(), _get_y_label(), plot_field_cumulative(), plot_field_derived(), plot_field_rates() (+45 more)

### Community 22 - "Viewer3DEngine"
Cohesion: 0.09
...
Cohesion: 0.09
Nodes (19): LLMClient, LLM client with Groq, OpenAI-compatible, and offline fallback., Send chat messages with tools to LLM. Args: messages: List of message dicts…, LLM client supporting Groq, OpenAI-compatible endpoints, and offline mode., Initialize client. Never raises; falls back to offline mode if no keys., chat() variant requesting JSON output via response_format. Both the Groq and…, Initialize the provider selected by settings.active_llm_client. Gated on the…, Ask the LLM for a JSON object and parse it. Uses provider JSON mode… (+11 more)

### Community 52 - "resample_summary"
Cohesion: 0.13
...
Cohesion: 0.07
Nodes (26): 1.1 Chat crash and the missing error boundary, 1.2 Markdown rendering in Learn and Chat, 1.3 Deck Editor section navigation, 1.4 Builder form state lost on navigation, 2.1 Home reorder and heading, 2.2 Collapsible sidebar, 2.3 Rename Linter to "Simulation Deck Checker (.DATA)", 3.1 ResInsight launch button (localhost-gated) (+18 more)

### Community 58 - "opmCompletions.test.ts"
Cohesion: 0.19
...
Cohesion: 0.12
Nodes (24): client(), params_client(), fixture, integration, Path, Tests for GET /api/keywords (editor autocomplete source)., A keyword only seen in fixtures (high count, no ERM section) is present in the…, Union is at least as large as the fixture catalogue (1079). (+16 more)

### Community 69 - "test_catalogue.py"
Cohesion: 0.11
...
Cohesion: 0.10
Nodes (15): skipif, Integration tests for running OPM simulations and comparing results., Test running simulations and comparing results., Test running a basic OPM simulation., Test comparing simulation results with reference data., Test comparison of simulation results., Test comparison of EGRID files., Test comparison of ESMRY files. (+7 more)

### Community 83 - "Pre-Processing / PVT & Rock-Property Pipeline  (module: `opm_ai.preprocess`)"
Cohesion: 0.10
Nodes (19): 1. Role in the AIM, 2. Position in build order, 3. Hard API contract (proposed - no test exists yet), 4. Key design decisions, 5. Toolchain grounding, 6. Implementation approach (ordered steps), 7. Risks and open questions, 8. Verification and done-criteria (+11 more)

### Community 84 - "Part 7: Educational Explainer & RAG Engine  (module: `opm_ai.explainer`)"
Cohesion: 0.10
Nodes (19): 1. Role in the AIM, 2. Position in build order, 3. Hard API contract (proposed - no test exists yet), 4. Key design decisions, 5. Toolchain grounding, 6. Implementation approach (concrete, ordered steps), 7. Risks and open questions, 8. Verification and done-criteria (+11 more)
...
Cohesion: 0.11
Nodes (17): 1. Plot Data Display Fix, 2. Dynamic Grid Layout, 3. Per-Property Plotting, 4. Unit Conversion, Backend (Python), Backend Tests, Concerns / Limitations, Files Modified (+9 more)

### Community 99 - "MSW (Multi-Segment Well) Test Documentation"
Cohesion: 0.11
Nodes (15): MSW-2D-HZ-01 Description and Results, MSW-2D-HZ Description and Results, MSW-3D-01 Description and Results, MSW-3D-02 Description and Results, MSW-3D-03 Description and Results, MSW-3D-04 Description and Results, MSW-3D-05 Description and Results, MSW-3D-06 Description and Results (+7 more)

### Community 100 - "Part 1: OPM Flow engine wrapper  (module: opm_ai.runner)"
Cohesion: 0.12
Nodes (16): 1. Role in the AIM, 2. Position in build order, 3. Hard API contract, 4.1 subprocess to /usr/bin/flow (primary) vs opm.simulators.BlackOilSimulator, 4.2 Exact command template, 4.3 Exit code and timeout handling, 4.4 Crash and warning parsing, 4.5 Output file discovery (+8 more)

### Community 101 - "UI Design Specification"
Cohesion: 0.12
...
Cohesion: 0.12
Nodes (15): Architecture, Backend (`opm_ai/`), Branch and commit strategy, Components and boundaries, Data flow, Decisions recorded, Error handling, Frontend (+7 more)

### Community 110 - "ACTIONX Tests Using the MODEL02 Model"
Cohesion: 0.17
Nodes (12): ACTIONX_COMPDAT Description and Results, ACTIONX_COMPLUMP Description and Results, ACTIONX_GCONINJE Description and Results, ACTIONX_GCONPROD Description and Results, ACTIONX_GCONSUMP Description and Results, ACTIONX_GRUPTREE Description and Results, ACTIONX Tests Using the MODEL02 Model, ACTIONX_WCONINJE Description and Results (+4 more)

### Community 111 - "_first"
Cohesion: 0.17
Nodes (12): _first(), `8*` is a DEFAULT_N_STAR with column_count=8., `8*100` is a REPEAT_N_VALUE with column_count=8, text='100'., `8*1.5` is a REPEAT_N_VALUE, text='1.5', column_count=8., `8*+1.5` and `8*-1.5` parse the sign into the value., `5*1.5e-3` has an exponent., test_default_n_star(), test_realistic_spe1_excerpt() (+4 more)

### Community 112 - "Timestepping and Convergence in OPM Flow"
Cohesion: 0.12
...
Cohesion: 0.13
Nodes (14): 1. HTTP endpoints, 2. Frontend module boundary, 3. Conventions to follow, 3D Viewer: API and module contract, `colormaps.ts` — palettes and scalar-to-colour mapping, `engine.ts` — three.js scene, owns the canvas, no React, GET `/api/results/{job_id}/grid/cells` → binary, GET `/api/results/{job_id}/grid/info` → JSON `GridInfoResponse` (+6 more)

### Community 116 - "Part 6 - Conversational AI Layer (module: opm_ai.api + frontend/)"
Cohesion: 0.13
...
Cohesion: 0.13
Nodes (9): POLYMER-01 REF Results, POLYMER-02 ECL Results, POLYMER-02 REF Results, POLYMER-03 ECL Results, POLYMER-03 REF Results, POLYMER-01 Description and Results, POLYMER-02 Description and Results, POLYMER-03 Description and Results (+1 more)

### Community 119 - "WPIMULT.md"
Cohesion: 0.13
...
Cohesion: 0.20
Nodes (14): ImportedResultResponse, post_imported_results(), Path, post, Request, Ensure at least one summary file pair is present; return (accepted, warnings).…, _safe_filename(), _validate_imported_files() (+6 more)

### Community 122 - "routes/settings.py"
Cohesion: 0.22
Nodes (13): _current_state(), get_settings(), BaseModel, get, post, Settings route: runtime LLM provider/key overrides. POST sets IN-MEMORY…, Runtime settings override. Keys are optional; empty string clears a key., Current settings state. Booleans only for keys - never key material. (+5 more)

### Community 123 - "Key Invariants"
Cohesion: 0.14
...
Cohesion: 0.15
Nodes (12): 1. Role in the AIM, 2. Position in Build Order, 3. Hard API Contract, 4. Key Design Decisions, 5. Toolchain Grounding, 6.1 Files to Create / Modify, 6.2 Ordered Steps, 6. Implementation Approach (+4 more)

### Community 129 - "System Prompt for OPM AI Assistant"
Cohesion: 0.15
Nodes (12): Clarifying Questions to Ask, Common Scenarios, Conversation Style, Deck Structure (Eclipse/OPM Flow format), Domain Knowledge, Example Workflow, Offline Mode, Physical Validity Rules (+4 more)

### Community 130 - "opm_ai/linter - Context"
Cohesion: 0.15
Nodes (12): Cross-Reference, Future / Plan, Key Implementation Files, Keyword Catalogue (L016 dependency, dual-source as of 2026-08-04), Offline-First Invariant, opm_ai/linter - Context, Purpose, Regex Pitfall (recurring bug, now fixed everywhere) (+4 more)

### Community 131 - "eclipse_fileformat/resources/js/MathJax/jax/input/AsciiMath/jax.js"
Cohesion: 0.42
Nodes (12): B(), c(), e(), L(), M(), n(), R(), T() (+4 more)

### Community 132 - "eclipse/resources/js/MathJax/jax/input/AsciiMath/jax.js"
Cohesion: 0.42
Nodes (12): B(), c(), e(), L(), M(), n(), R(), T() (+4 more)
...
Cohesion: 0.17
Nodes (11): 1. Install OPM Flow on Ubuntu 24.04, 2. Install GitHub Actions Self-Hosted Runner, 3. Verify Runner Registration, 4. Enable the Integration Workflow, 5. Verify Flow is Accessible in Runner Context, 6. Run Integration Tests Locally (for debugging), Alternative: Docker-based Runner, Prerequisites (+3 more)
...
Cohesion: 0.17
Nodes (11): API, Extraction Heuristics (extract.py), Future / Plan, opm_ai/builder - Context, Pipeline, Preprocess Integration (Fluid-Specific PVT), Purpose, Template Invariants (base.j2) (+3 more)

### Community 137 - "OPM Flow `.DATA` Linter v2"
Cohesion: 0.17
Nodes (11): Calibration methodology, CLI, Lint rules, LLM fallback, Module layout, OPM Flow `.DATA` Linter v2, Programmatic API, Self-heal design philosophy (+3 more)

### Community 138 - "TestExplainEndpoint"
Cohesion: 0.17
Nodes (7): POST /api/explain with both topic and kpis -> 422., POST /api/explain with neither topic nor kpis -> 422., Test all three explanation levels., Tests for POST /api/explain, POST /api/explain with topic -> 200, non-empty text, 1-5 citations, level…, POST /api/explain with KPIs dict -> 200, non-empty text., TestExplainEndpoint

### Community 139 - "test_keyword_processing.py"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (10): Cleanup and performance pass, Goal, Risks, Stage 1: delete dead dependencies and dead code, Stage 2: consolidate the duplication that costs something, Stage 3: performance, Stage 4: contract fix and test wiring, Verification at every stage (+2 more)

### Community 142 - "Frontend Context"
Cohesion: 0.18
Nodes (10): 3D Viewer (`src/components/viewer3d/`), Dev / Prod Serving, Frontend Context, Future Work, Key Files, KPI Card Keys (must match `opm_ai/postprocess/kpi.py::extract_kpis` output exactly), Navigation, Stack (+2 more)

### Community 143 - "package.json"
Cohesion: 0.18
Nodes (10): name, private, scripts, build, dev, lint, preview, test (+2 more)

### Community 144 - "deckSections.ts"
Cohesion: 0.18
...
Cohesion: 0.18
Nodes (10): Deviation Note: BM25 vs Vector DB, Explainer (explainer.py), Key Types (models.py), Knowledge Base, opm_ai.explainer - Educational Explainer & RAG Engine, Purpose, Quiz (quiz.py), Report (report.py) (+2 more)

### Community 147 - "PVT Basics: Solution Gas, Formation Volume Factor, and Bubble Point"
Cohesion: 0.18
Nodes (10): 1. Solution Gas-Oil Ratio (Rs), 2. Oil Formation Volume Factor (Bo), 3. Gas Formation Volume Factor (Bg), 4. Bubble Point Pressure (Pb), Eclipse Keywords, Impact on Simulation, In OPM Flow, Key PVT Properties (+2 more)

### Community 148 - "Well Controls in Eclipse/OPM Flow: Rate vs BHP Control"
Cohesion: 0.18
Nodes (10): 1. Rate Control (Surface Rate), 2. BHP Control (Bottom-Hole Pressure), Common Issues, Control Switching (Constraints), Control Types, Key Keywords Summary, OPM Flow Specifics, VFP Tables (Vertical Flow Performance) (+2 more)

### Community 149 - "LintResult"
Cohesion: 0.20
...
Cohesion: 0.20
Nodes (9): Backend (new + modified), Design decisions, Files, Frontend (new + modified), Goal, Out of scope, Plan: Deck Upload with include/ folder (Simulator page), Tests (new) (+1 more)

### Community 154 - "SPE1: The Classic Reservoir Simulation Benchmark"
Cohesion: 0.20
Nodes (9): Common Issues When Running, Expected Summary Vectors, Key Results (Odeh Reference), OPM Flow SPE1 Decks, Problem Description, Running SPE1 in OPM Flow, SPE1: The Classic Reservoir Simulation Benchmark, Teaching Value (+1 more)

### Community 155 - "props.py"
Cohesion: 0.24
...
Cohesion: 0.22
Nodes (8): build_keyword_catalogue.py (Stage 3.4, observational), build_keyword_rm_catalogue.py (Stage 3.4, authoritative), Files, Future / Plan, Purpose, run.sh / smoke.sh / with-py.sh, scripts/ - Build-time catalogue generators and run helpers, Test Contracts

### Community 160 - "devDependencies"
Cohesion: 0.25
Nodes (7): devDependencies, jsdom, @testing-library/jest-dom, @testing-library/react, jsdom, @testing-library/jest-dom, @testing-library/react

### Community 161 - "frontend/src/components/ - React components"
Cohesion: 0.25
Nodes (7): Conventions, frontend/src/components/ - React components, Future / Plan, Lint summary rendering (2026-08-04), OPM language support (Monaco), Purpose, Tests

### Community 162 - "opm_ai/api/routes/ - FastAPI route handlers"
Cohesion: 0.25
...
Cohesion: 0.25
Nodes (7): Characteristics, Comparison with Other Drive Mechanisms, Depletion Drive (Solution Gas Drive), In OPM Flow, Key Equations, Physical Mechanism, Simulation Considerations

### Community 165 - "Relative Permeability and the Corey Model"
Cohesion: 0.25
...
Cohesion: 0.25
Nodes (7): Dependencies, OPM-AI Test Suite, Running Tests, Test Categories, Test Fixtures, Test Structure, Writing Tests

### Community 175 - "Settings"
Cohesion: 0.29
Nodes (5): BaseSettings, Application settings loaded from environment variables and .env file., Return True if running in offline mode (no API keys)., Return the active LLM provider name ("offline" unless opted in)., Settings

### Community 176 - "OPM-AI Conversation Documentation Index"
Cohesion: 0.29
...
Cohesion: 0.33
Nodes (5): Documentation Complete, Finalization Checklist (2026-07-18), Ready to Build, Tasks Created for Stage 0.5, Verified Facts (grounded in code/filesystem, not aspirations)

### Community 179 - "Aquifer Test Documentation"
Cohesion: 0.33
...
Cohesion: 0.40
Nodes (4): AmbiguousCorrelation, CorrelationName, Exception, Raised when multiple correlations are equally valid and user must choose.

### Community 187 - "run.sh"
Cohesion: 0.40
...
Cohesion: 0.50
Nodes (3): 3D viewer render harness, Headless WebGL, Running it

### Community 190 - "Per-scenario Jinja2 children"
Cohesion: 0.50
...
Cohesion: 0.50
Nodes (3): Fluid descriptor (opm_ai/preprocess/models.py), Preprocessing module for PVT and rock-property pipeline., Provides correlation functions, table builders, and validators.

### Community 193 - "smoke.sh"
Cohesion: 0.83
